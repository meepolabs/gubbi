...
FIXTURE_COMMENT: list[str] = [
    ...
    "resolver gubbi.tools.context._resolve_period(period, today), which is the",
    ...
    "",
    "This fixture pins the WEB side only: a change to the Python resolver is UNCAUGHT",
    "here until the Python-side drift test that regenerates these bytes and diffs them",
    "exists. Until then a green web suite proves the web has not drifted from this",
    "snapshot, not that the snapshot still matches Python.",
    "",
