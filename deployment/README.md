...
| `OTEL_EXPORTER_OTLP_HEADERS` | (empty) | Headers for OTLP export. Empty for gubbi -> Collector (internal network). |
...
`gubbi-cloud/deployment/otel-collector/` directory for Collector
configuration.
