...
# noqa S608 comments are only in this single file (1-2 uses per the
# centralization heuristic; leave them in place).
...
USAGE::
    ...
    JOURNAL_ENCRYPTION_MASTER_KEY_V1="base64-..." \\
        ...
        python -m gubbi.scripts.rotate_encryption_key --from-version 1 --to-version 2
